...
<!--   <div class="d-flex" id="wrapper">
    ...
    <!--     <a href="{{ route('posts.index') }}" class="list-group-item list-group-item-action bg-light"><h4>Manage Posts</a> -->
        <!-- <a href="{{ route('addnotices.index') }}" class="list-group-item list-group-item-action bg-light"><h4>Manage Notices</h4></a> -->
      <!--   <a href="{{ route('tags.index') }}" class="list-group-item list-group-item-action bg-light"><h4>Manage Tags</h3></a> -->
